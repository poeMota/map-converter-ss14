...
class SettingsFrame(ctk.CTkFrame):
    ...
    def validate_config(self):
        ...
        for row in self.frames.values():
            tileName = row.tileEntry.get()
            if (not GlobalSettings().allowUseUnregistredTiles and
                tileName not in _tilesRefsManager.tileRefs):
                raise ValueError(f"Unknown tile: {tileName}")
